...
public:
    ...
    */
    ...
    /**
        ...
        @param[out] primary
            Pointer to a location to store the primary colour, or @nullptr.
        @param[out] secondary
            Pointer to a location to store the secondary colour, or @nullptr.
        @param[out] tertiary
            Pointer to a location to store the tertiary colour, or @nullptr.
    */
    ...
    */
    ...
    /**
        ...
        @param size
            ...
            can have three distinct sizes: wxRIBBON_BUTTONBAR_BUTTON_SMALL,
            wxRIBBON_BUTTONBAR_BUTTON_MEDIUM, and wxRIBBON_BUTTONBAR_BUTTON_LARGE.
            If the requested size-class is not applicable, then @nullptr should
            be returned.

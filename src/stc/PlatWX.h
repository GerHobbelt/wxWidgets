...
public:
    ...
    virtual void SetFont(Scintilla::Font &font) override;
    virtual void Create(Scintilla::Window &parent, int ctrlID, Scintilla::Point location_, int lineHeight_, bool unicodeMode_, int technology_) override;
    ...
    virtual void SetDelegate(Scintilla::IListBoxDelegate *lbDelegate) override;
